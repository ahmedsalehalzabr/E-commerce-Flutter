                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: _item.addItem!.is_default == "1" ? colors.primary : Theme.of(context).colorScheme.white,
                                    border: Border.all(color: colors.primary)),
                                child: Padding(
                                  padding: const EdgeInsets.all(2.0),
                                  child: _item.addItem!.is_default == "1"
                                      ? Icon(
                                          Icons.check,
                                          size: 15.0,
                                          color: Theme.of(context).colorScheme.white,
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: _item.addItem!.is_default == "0"
                                        ? Text(
                                        ...
                                        : Text(
                                            getTranslated(context, 'MARKED_DEFAULT')!,
                                            style: TextStyle(
                                              color: Theme.of(context).colorScheme.fontColor,
                                            ),
                                          ),
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(color: Theme.of(context).colorScheme.fontColor, fontSize: 10),
                                    ),
                                  ),
                                ),
                              ),
