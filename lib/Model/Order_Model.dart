...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    if (attachments.isEmpty) {
      ...
      attachmentList = attachments.map((data) => Attachment.fromJson(data)).toList();
    }
    ...
    return OrderModel(
        ...
        delDate: parsedJson[DEL_DATE] != "" ? DateFormat('dd-MM-yyyy').format(DateTime.parse(parsedJson[DEL_DATE])) : '',
        ...
        pickTime: parsedJson[PICKUP_TIME] != "" ? DateFormat('dd-MM-yyyy').format(DateTime.parse(parsedJson[PICKUP_TIME])) : '',
...
class Attachment {
  ...
  factory Attachment.fromJson(Map<String, dynamic> json) {
    return Attachment(id: json[ID], attachment: json[ATTACHMENT], bankTranStatus: json[BANK_STATUS]);
  }
}
