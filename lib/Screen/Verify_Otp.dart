...
import 'package:numo/Screen/Set_Password.dart';
...
class _MobileOTPState extends State<VerifyOtp> with TickerProviderStateMixin {
  ...
  void _onVerifyCode() async {
    ...
    final PhoneVerificationCompleted verificationCompleted =
      ...
      log('PhoneVerificationCompleted');
      _firebaseAuth
        ...
        if (value.user != null) {
          ...
          if (widget.title == getTranslated(context, 'SEND_OTP_TITLE')) {
            Future.delayed(const Duration(seconds: 2)).then((_) {
              settingsProvider.setPrefrence(MERCHANTUSER_PHONE1, widget.mobileNumber!);
    ...
    final PhoneCodeSent codeSent =
      ...
      log('Verify_Otp PhoneCodeSent verificationId = $verificationId');
...
//----------------------
    ...
    log('VerifyOtp _onFormSubmitted ');
    if (code.length == 6) {
      log('VerifyOtp _onFormSubmitted otp = $otp');
      ...
      _firebaseAuth
        ...
        log('VerifyOpt _onFormSubmitted _firebaseAuth value=$value');
       
        if (value.user != null) {
          log('_onFormSubmitted');
