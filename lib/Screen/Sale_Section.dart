...
class Sale_Section extends StatefulWidget {
  ...
  Sale_Section({Key? key, this.index, this.section_model, this.dis, this.sectionList}) : super(key: key);
...
class StateSection extends State<Sale_Section> with TickerProviderStateMixin {
  ...
  Widget listItem(int index) {
    if (index < widget.section_model!.productList!.length) {
      ...
      double off = 0;
      if (model.ProductAttributeValues![model.selVarient!].old_price! != "0") {
        off = (double.parse(model.ProductAttributeValues![model.selVarient!].price1!) -
                                                ...
                                                ? Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Text(
                                                        ...
                                                        style: TextStyle(
                                                            color: Theme.of(context).colorScheme.white, fontWeight: FontWeight.bold, fontSize: 9),
                                                      ),
                                                    ),
                                                  )
                                                : Container(),
                                                                      ...
                                                                      InkWell(
                                                                        ...
                                                                        onTap: () {
                                                                          if (_isProgress == false &&
                                                                              (int.parse(
                                                                                      model.ProductAttributeValues![model.selVarient!].cartCount!)) >
                                                                                  0) {
                                                                        ...
                                                                        onTap: () {
                                                                          if (_isProgress == false) {
                                                                            addToCart(
                                                                                index,
                                                                                (int.parse(model
                                                                                            .ProductAttributeValues![model.selVarient!].cartCount!) +
                              ...
                              child: InkWell(
                                onTap: () {
                                  if (_isProgress == false) {
                                    addToCart(
                                        index,
                                        (int.parse(model.ProductAttributeValues![model.selVarient!].cartCount!) + int.parse(model.qtyStepSize!))
                                            .toString(),
                                        1);
                                  }
                                },
      ...
      if (_isNetworkAvail) {
        if (CUR_MERCHANTID != null) {
          try {
            ...
            qty = (int.parse(model.ProductAttributeValues![model.selVarient!].cartCount!) - int.parse(model.qtyStepSize!));
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Expanded(
                        ...
                        children: [
                          Hero(
                            tag: "$index${widget.sectionList![widget.index!].productList![index].product_id}",
                            child: ClipRRect(
                              ...
                              ? Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        "${off.toStringAsFixed(0)}%",
                                        style: TextStyle(color: Theme.of(context).colorScheme.white, fontWeight: FontWeight.bold, fontSize: 9),
                                      ),
                                    ),
                                  ),
                                )
                                                ...
                                                ? Row(
                                                    children: <Widget>[
                                                      InkWell(
                                                        ...
                                                        onTap: () {
                                                          if (_isProgress == false &&
                                                              (int.parse(model.ProductAttributeValues![model.selVarient!].cartCount!)) > 0) {
                                                            removeFromCart(index);
                                                          }
                                                        },
                                                      ),
