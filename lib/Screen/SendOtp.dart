...
import 'package:numo/Screen/Privacy_Policy.dart';
import 'package:numo/Screen/Verify_Otp.dart';
...
//for testing ansi ===========================
      ...
      bool? error = false; //getdata["error"];
      ...
      if (widget.title == getTranslated(context, 'SEND_OTP_TITLE')) {
        ...
        if (true) {
          ...
          setSnackbar('ok go a head', context);
