...
import 'package:numo/Screen/Sale_Section.dart';
...
class _SaleState extends State<Sale> with AutomaticKeepAliveClientMixin<Sale>, TickerProviderStateMixin {
            ...
            ? RefreshIndicator(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsetsDirectional.only(bottom: 8.0, start: 10.0),
                        child: Text(
      ...
      children: [
        ...
        Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: Text(saleList[index].shortDesc ?? "", style: Theme.of(context).textTheme.subtitle2),
                ),
                InkWell(
                  child: Padding(
        ...
        ? Padding(
            ...
            child: GridView.count(
                ...
                children: List.generate(
                  saleList[i].productList!.length < 6 ? saleList[i].productList!.length : 6,
                  (index) {
  ...
  Widget productItem(int index, bool pad) {
    if (productList.length > index) {
      String? offPer;
      double price = double.parse(productList[index].ProductAttributeValues![0].old_price!);
      if (price == 0) {
        price = double.parse(productList[index].ProductAttributeValues![0].price1!);
      } else {
        double off = double.parse(productList[index].ProductAttributeValues![0].price1!) - price;
        offPer = ((off * 100) / double.parse(productList[index].ProductAttributeValues![0].price1!)).toStringAsFixed(0);
      }
      ...
      return Card(
        ...
        child: InkWell(
            ...
            children: <Widget>[
                      ...
                      child: ClipRRect(
                          ...
                          child: Hero(
                            ...
                            child: FadeInImage(
                              ...
                              image: NetworkImage(productList[index].product_image!),
              ...
              Padding(
                  ...
                  child: Text('${getPriceFormat(context, price)!} ',
                      style: TextStyle(color: Theme.of(context).colorScheme.fontColor, fontWeight: FontWeight.bold, fontSize: 11))),
              Padding(
                padding: const EdgeInsetsDirectional.only(start: 8.0, bottom: 8, top: 1),
                child: double.parse(productList[index].ProductAttributeValues![0].old_price!) != 0
                    ? Row(
                        children: <Widget>[
                          Text(
                            double.parse(productList[index].ProductAttributeValues![0].old_price!) != 0
                                ? getPriceFormat(context, double.parse(productList[index].ProductAttributeValues![0].price1!))!
                                : "",
                          ...
                          Flexible(
                            child: Text(" | " "-${productList[index].calDisPer}%",
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              PageRouteBuilder(pageBuilder: (_, __, ___) => ProductDetail(model: model, secPos: 0, index: index, list: false)),
            );
          },
        ),
      );
  ...
  Widget sectionItem(int secPos, int index, bool pad) {
    if (saleList[secPos].productList!.length > index) {
      String? offPer;
      double price = double.parse(saleList[secPos].productList![index].ProductAttributeValues![0].old_price!);
      if (price == 0) {
        price = double.parse(saleList[secPos].productList![index].ProductAttributeValues![0].price1!);
      } else {
        double off = double.parse(saleList[secPos].productList![index].ProductAttributeValues![0].price1!) - price;
        offPer = ((off * 100) / double.parse(saleList[secPos].productList![index].ProductAttributeValues![0].price1!)).toStringAsFixed(0);
      }
      ...
      return Card(
        ...
        child: InkWell(
          ...
          child: Column(
            ...
            children: <Widget>[
                  ...
                  children: [
                    Padding(
                      ...
                      child: ClipRRect(
                          ...
                          child: Hero(
                            transitionOnUserGestures: true,
                            tag: "$index${saleList[secPos].productList![index].product_id}",
                            child: FadeInImage(
                              fadeInDuration: const Duration(milliseconds: 150),
                              image: NetworkImage(saleList[secPos].productList![index].product_image!),
                              height: double.maxFinite,
                              width: double.maxFinite,
                              fit: extendImg ? BoxFit.fill : BoxFit.fitHeight,
                              imageErrorBuilder: (context, error, stackTrace) => erroWidget(double.maxFinite),
              ...
              Padding(
                ...
                child: Text(
                  saleList[secPos].productList![index].product_name!,
                  style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Theme.of(context).colorScheme.lightBlack),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                ),
              ...
              Padding(
                  padding: const EdgeInsetsDirectional.only(start: 8.0, top: 1.0),
                  child: Text('${getPriceFormat(context, price)!} ',
                      style: TextStyle(color: Theme.of(context).colorScheme.fontColor, fontWeight: FontWeight.bold, fontSize: 11))),
              Padding(
                padding: const EdgeInsetsDirectional.only(start: 8.0, bottom: 8, top: 1),
                child: double.parse(saleList[secPos].productList![index].ProductAttributeValues![0].old_price!) != 0
                    ? Row(
                        children: <Widget>[
                          Text(
                            double.parse(saleList[secPos].productList![index].ProductAttributeValues![0].old_price!) != 0
                                ? getPriceFormat(context, double.parse(saleList[secPos].productList![index].ProductAttributeValues![0].price1!))!
                                : "",
                            style: Theme.of(context).textTheme.overline!.copyWith(
                                decoration: TextDecoration.lineThrough,
                                letterSpacing: 0,
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              PageRouteBuilder(pageBuilder: (_, __, ___) => ProductDetail(model: model, secPos: secPos, index: index, list: false)),
            );
          },
        ),
      );
                  ...
                  children: [
                    GridView.count(
                        ...
                        children: List.generate(
                          ...
                          (index) {
                            return productItem(index, index % 2 == 0 ? true : false);
                          },
                        )),
                    Container(
                          ...
                          Navigator.push(
                              ...
                              CupertinoPageRoute(
                                builder: (context) => ProductList(
                                  category_name: getTranslated(context, 'OFFER'),
                                  category_id: '',
                                  tag: false,
                                  dis: disList[curDis],
                                  fromSeller: false,
  ...
  Future<void> callApi() async {
    ...
    user.setMerchantUserId(setting.merchant_id);
  ...
  void getProduct(String top) {
    try {
      Map<String, dynamic> parameter = {TOP_RETAED: top, DISCOUNT: disList[curDis].toString()};
      ...
      apiBaseHelper.getNumoAPICall(getNumoProductsApi, parameter, null).then((getdata) {
        ...
        if (getdata != null) {
          ...
          tempList = (data as List).map((data) => Product.fromJson(data)).toList();
          ...
          setSnackbar(getTranslated(context, 'VAR_NT_AVAIL_LBL')!, context);
  ...
  void getSection() {
    try {
      Map parameter = {PRODUCT_LIMIT: "6", PRODUCT_OFFSET: "0", DISCOUNT: disList[curDis].toString()};
      ...
      apiBaseHelper.postAPICall(getSectionApi, parameter).then((getdata) {
        ...
        if (!error) {
          ...
          saleList = (data as List).map((data) => SectionModel.fromJson(data)).toList();
        } else {
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "${disList[index]}%",
                        style: TextStyle(color: curDis == index ? Theme.of(context).colorScheme.white : Theme.of(context).colorScheme.fontColor),
                      ),
                    ),
                  ],
                ),
