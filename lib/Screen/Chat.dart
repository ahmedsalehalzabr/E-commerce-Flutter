...
class _ChatState extends State<Chat> {
  ...
  Widget msgItem(int index, Model message) {
    if (message.uid == context.read<SettingProvider>().merchant_id) {
      //Own message
      return Row(
  ...
  Widget MsgContent(int index, Model message) {
    ...
    return Column(
      ...
      crossAxisAlignment: message.uid == settingsProvider.merchant_id ? CrossAxisAlignment.end : CrossAxisAlignment.start,
      children: <Widget>[
        message.uid == settingsProvider.merchant_id
            ? Container()
            : Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text(capitalize(message.name!), style: const TextStyle(color: colors.primary, fontSize: 12)),
                    )
                  ],
                ),
              ),
        ...
        message.msg != null && message.msg!.isNotEmpty
            ? Card(
                elevation: 0.0,
                color: message.uid == settingsProvider.merchant_id
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(message.date!, style: TextStyle(color: Theme.of(context).colorScheme.lightBlack, fontSize: 9)),
                      ),
                    ],
                  ),
                ),
  ...
  Future<void> sendMessage(String message) async {
    ...
    request.fields[USER_ID] = settingsProvider.merchant_id!;
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      InkWell(
                        ...
                        child: type == "image"
                            ? Image.network(file,
                                width: 250, height: 150, fit: BoxFit.cover, errorBuilder: (context, error, stackTrace) => erroWidget(150))
                            : Image.asset(
                                icon,
                                width: 100,
                                height: 100,
