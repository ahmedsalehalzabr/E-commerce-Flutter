...
import 'package:numo/Model/Order_Model.dart';
import 'package:numo/Screen/Review_Gallary.dart';
import 'package:numo/Screen/Review_Preview.dart';
...
class StateOrder extends State<OrderDetail> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
                ...
                child: Row(
                  ...
                  children: [
                    Text("${getTranslated(context, 'PRICE_LBL')!} :",
                        style: Theme.of(context).textTheme.button!.copyWith(color: Theme.of(context).colorScheme.lightBlack2)),
      ...
      return Card(
          ...
          child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Padding(
                    padding: const EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
                    child: Text(widget.model!.address!, style: TextStyle(color: Theme.of(context).colorScheme.lightBlack2))),
                Padding(
                    padding: const EdgeInsetsDirectional.only(start: 15.0, end: 15.0),
              ...
              itemBuilder: (context, i) {
                return Padding(
                  ...
                  child: InkWell(
                    child: Text(
                      "Attachment ${i + 1}",
                      style: TextStyle(decoration: TextDecoration.underline, color: Theme.of(context).colorScheme.fontColor),
                    ),
                    onTap: () {
        ...
        Expanded(
          child: SizedBox(
            ...
            child: ListView.builder(
              ...
              itemCount: model.orderPrescriptionAttachments!.length > 5 ? 5 : model.orderPrescriptionAttachments!.length,
              itemBuilder: (context, index) {
                return Padding(
                  padding: const EdgeInsetsDirectional.only(top: 8.0, bottom: 8, end: 8),
                  child: InkWell(
  ...
  void _launchURL(String url) async => await canLaunchUrlString(url) ? await launchUrlString(url) : throw 'Could not launch $url';
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.model!.isLocalPickUp != "1" ? getTranslated(context, 'ORDER_SHIPPED')! : getTranslated(context, 'READY_TO_SHIP_LBL')!,
                      style: const TextStyle(fontSize: 8),
                      textAlign: TextAlign.center,
                    ),
                    Text(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.model!.isLocalPickUp != "1" ? getTranslated(context, 'ORDER_DELIVERED')! : getTranslated(context, 'PICKED_UP_LBL')!,
                      style: const TextStyle(fontSize: 8),
                      textAlign: TextAlign.center,
                    ),
                    Text(
            ...
            child: InkWell(
                ...
                onTap: () async {
                  ...
                  if (status == PermissionStatus.granted) {
                    ...
                    try {
                      generatedPdfFile = await FlutterHtmlToPdf.convertFromHtmlContent(widget.model!.invoice!, targetPath.toString(), targetFileName);
    ...
    return Padding(
      ...
      child: TabBar(
        ...
        tabs: [
          ...
          getTab(widget.model!.isLocalPickUp != "1" ? getTranslated(context, "DELIVERED")! : getTranslated(context, 'PICKED_UP_LBL')!),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        if (activeStatus != '') {
          ...
          if ((orderItem.status == SHIPED || orderItem.status == PLACED || orderItem.status == READY_TO_PICKUP) && activeStatus == PROCESSED) {
            return productItem(orderItem, model);
          }
        } else {
          return productItem(orderItem, model);
    ...
    return Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            border: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).colorScheme.lightBlack, width: 1.0)),
            hintText: getTranslated(context, 'REVIEW_HINT_LBL'),
            hintStyle: Theme.of(context).textTheme.subtitle2!.copyWith(color: Theme.of(context).colorScheme.lightBlack2.withOpacity(0.7)),
          ),
        ));
  }
        ...
        Expanded(
          child: Padding(
            ...
            child: MaterialButton(
              ...
              color: colors.primary,
              child: Text(
                orderItem.userReviewRating != "0" ? getTranslated(context, "UPDATE_REVIEW_LBL")! : getTranslated(context, "SEND_REVIEW")!,
              ),
            ),
          ),
        ),
                      ...
                      children: [
                        ...
                        model.tracking_id! != ""
                            ? RichText(
                                ...
                                TextSpan(
                                  text: "",
                                  style: TextStyle(color: Theme.of(context).colorScheme.lightBlack, fontWeight: FontWeight.bold),
                                ),
                                TextSpan(
                        ...
                        InkWell(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                color: Theme.of(context).colorScheme.lightWhite, borderRadius: const BorderRadius.all(Radius.circular(4.0))),
                            child: Text(
                ...
                child: Column(
                  ...
                  children: [
                    Text("${getTranslated(context, 'NOTE')}:",
                        style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Theme.of(context).colorScheme.lightBlack2)),
                    Text(model.note!, style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Theme.of(context).colorScheme.lightBlack2)),
                  ],
                ),
              ),
            ),
