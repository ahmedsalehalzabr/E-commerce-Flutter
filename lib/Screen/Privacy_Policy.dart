  ...
  Future<void> getSetting() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        apiBaseHelper.getNumoAPICall((type == ABOUT_US || type == CONTACT_US) ? getNumoSettingApi : getNumoTermsApi, parameter, null).then((getdata) {
          // bool error = getdata["error"];
          // String? msg = getdata["message"];
          if (getdata != null) {
            log('Privacy_Policy getSetting getdata=$getdata');
            privacy = getdata[0][type].toString();
            log('Privacy_Policy getSetting privacy=$privacy');
          } else {
