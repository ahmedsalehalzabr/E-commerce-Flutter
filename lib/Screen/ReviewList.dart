...
import 'package:numo/Provider/order_provider.dart';
import 'package:numo/Screen/write_review.dart';
...
class StateRate extends State<ReviewList> {
  ...
  var star1 = "0", star2 = "0", star3 = "0", star4 = "0", star5 = "0", averageRating = "0";
  String? userComment = "", userRating = "0.0";

  @override
  void initState() {
    for (var element in reviewList) {
      if (element.userId == CUR_MERCHANTID) {
    ...
    Future.delayed(Duration.zero, () {
      Provider.of<OrderProvider>(context, listen: false).fetchOrderDetails(CUR_MERCHANTID, "delivered");
    });
    ...
    return Scaffold(
        ...
        floatingActionButton: widget.model!.isPurchased == "true"
            ? FloatingActionButton.extended(
                ...
                onPressed: () {
                  openBottomSheet(context, widget.id, userComment, double.parse(userRating!));
                },
              )
            : Container());
  }

  Future<void> openBottomSheet(BuildContext context, var productID, var userReview, double userRating) async {
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color: isPhotoVisible ? colors.primary : Theme.of(context).colorScheme.white,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(color: Theme.of(context).colorScheme.lightBlack2, fontSize: 11),
                                    )
                                  ],
                                ),
                      ...
                      Positioned(
                        ...
                        child: ClipRRect(
                          ...
                          child:
                            ...
                            imageErrorBuilder: (context, error, stackTrace) => errorWidget(36),
                          ),
                        ),
                      ),
                    ],
