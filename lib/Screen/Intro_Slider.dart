...
import 'package:numo/Screen/SignInUpAcc.dart';
    ...
    return Column(
      children: [
        ...
        Center(
          ...
          child: AppBtn(
              title: _currentPage == 0 || _currentPage == 1 ? getTranslated(context, 'NEXT_LBL') : getTranslated(context, 'GET_STARTED'),
              btnAnim: buttonSqueezeanimation,
              btnCntrl: buttonController,
              onBtnSelected: () {
                if (_currentPage == 2) {
                  log('IntroSlider - finished slides');
                  SettingProvider settingsProvider = Provider.of<SettingProvider>(context, listen: false);
                  settingsProvider.setPrefrenceBool(ISFIRSTTIME, true);
                  ...
                  _pageController.animateToPage(_currentPage, curve: Curves.decelerate, duration: const Duration(milliseconds: 300));
                }
              }),
        )),
      ],
    ...
    for (int i = 0; i < slideList.length; i++) {
      childs.add(AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: _currentPage == i ? Theme.of(context).colorScheme.fontColor : Theme.of(context).colorScheme.lightBlack.withOpacity(0.7),
          )));
    }
    return childs;
  }
