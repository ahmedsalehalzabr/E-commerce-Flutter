...
import 'package:numo/Screen/Customer_Support.dart';
import 'package:numo/Screen/MyTransactions.dart';
import 'package:numo/Screen/ReferEarn.dart';
import 'package:numo/Screen/SendOtp.dart';
...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  void initState() {
    Future.delayed(Duration.zero, () {
      ...
      themeList = [getTranslated(context, 'SYSTEM_DEFAULT'), getTranslated(context, 'LIGHT_THEME'), getTranslated(context, 'DARK_THEME')];
  ...
  _getSaved() async {
    ...
    //CUR_MERCHANTID = await settingsProvider.getPrefrence(ID) ?? '';
    mob = await settingsProvider.getPrefrence(MERCHANTUSER_PHONE1) ?? '';
          ...
          child: Row(
            children: [
              Selector<UserProvider, String>(
                  selector: (_, provider) => provider.curMerchantUserImage,
                  builder: (context, profileImage, child) {
                    return getUserImage(profileImage, openChangeUserDetailsBottomSheet);
                  }),
              Column(
                ...
                children: [
                  Selector<UserProvider, String>(
                      selector: (_, provider) => provider.curMerchantUserName,
                      builder: (context, userName, child) {
                        log('MyProfile _getHeader userName=$userName');
                  ...
                  // Selector<UserProvider, String>(
                  //     selector: (_, provider) => provider.curMerchantComName,
                  //     builder: (context, comName, child) {
                  //       log('MyProfile _getHeader comName=$comName');
                  //       // nameController = TextEditingController(text: comName);
                  //       return Text(
                  //         comName,
                  //         style: Theme.of(context).textTheme.subtitle1!.copyWith(
                  //               color: Theme.of(context).colorScheme.fontColor,
                  ...
                  //     }),
                  Selector<UserProvider, String>(
                      selector: (_, provider) => provider.curMerchantUserPhone1!,
                      builder: (context, userMobile, child) {
                        log('MyProfile _getHeader userMobile=$userMobile');
                        return userMobile != ""
                            ? Text(
                                userMobile,
                  ...
                  Selector<UserProvider, String>(
                      selector: (_, provider) => provider.curMerchantComName,
                      builder: (context, comName, child) {
                        comNameController = TextEditingController(text: comName);
                        return comName != ""
                            ? Text(
                                comName,
                                style: Theme.of(context)
                  ...
                  Consumer<UserProvider>(builder: (context, userProvider, _) {
                    return userProvider.curMerchantUserName == ""
                        ? Padding(
                            padding: const EdgeInsetsDirectional.only(top: 7),
                            child: InkWell(
                              child: Text(getTranslated(context, 'LOGIN_REGISTER_LBL')!,
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: selectLan == index ? colors.primary : Theme.of(context).colorScheme.white,
  ...
  Future<void> setUpdateUser(String userID, [oldPwd, newPwd, username, userEmail]) async {
    ...
    if (!error) {
      ...
      if ((username != "") && (userEmail != "")) {
        ...
        userProvider.setMerchantUserName(username);
        settingProvider.setPrefrence(EMAIL, userEmail);
        userProvider.setMerchantEmail(userEmail);
      }
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        CUR_MERCHANTID == "" || CUR_MERCHANTID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'MY_ORDERS_LBL')!, 'assets/images/pro_myorder.svg'),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null ? Container() : _getDivider(),

        CUR_MERCHANTID == "" || CUR_MERCHANTID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'MANAGE_ADD_LBL')!, 'assets/images/pro_address.svg'),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null ? Container() : _getDivider(),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null
        //     ? Container()
        //     : _getDrawerItem(getTranslated(context, 'MYWALLET')!, 'assets/images/pro_wh.svg'),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null
        //     ? Container()
        //     : _getDrawerItem(getTranslated(context, 'YOUR_PROM_CO')!, 'assets/images/promo.png'),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null ? Container() : _getDivider(),

        CUR_MERCHANTID == "" || CUR_MERCHANTID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'MYTRANSACTION')!, 'assets/images/pro_th.svg'),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null ? Container() : _getDivider(),

        _getDrawerItem(getTranslated(context, 'CHANGE_THEME_LBL')!, 'assets/images/pro_theme.svg'),

        // _getDivider(),

        _getDrawerItem(getTranslated(context, 'CHANGE_LANGUAGE_LBL')!, 'assets/images/pro_language.svg'),

        //  CUR_MERCHANTID == "" || CUR_MERCHANTID == null ? Container() : _getDivider(),

        CUR_MERCHANTID == "" || CUR_MERCHANTID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'CHANGE_PASS_LBL')!, 'assets/images/pro_pass.svg'),

        // _getDivider(),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null || !refer
        //     ? Container()
            // : _getDrawerItem(getTranslated(context, 'REFEREARN')!, 'assets/images/pro_referral.svg'),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null ? Container() : _getDivider(),

        CUR_MERCHANTID == "" || CUR_MERCHANTID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'CUSTOMER_SUPPORT')!, 'assets/images/pro_customersupport.svg'),

        // _getDivider(),

        _getDrawerItem(getTranslated(context, 'ABOUT_LBL')!, 'assets/images/pro_aboutus.svg'),

        // _getDivider(),

        _getDrawerItem(getTranslated(context, 'CONTACT_LBL')!, 'assets/images/pro_contact_us.svg'),

        // _getDivider(),

        // _getDrawerItem(getTranslated(context, 'FAQS')!, 'assets/images/pro_faq.svg'),

        // _getDivider(),

        _getDrawerItem(getTranslated(context, 'PRIVACY')!, 'assets/images/pro_pp.svg'),

        // _getDivider(),

        _getDrawerItem(getTranslated(context, 'TERM')!, 'assets/images/pro_tc.svg'),

        _getDrawerItem(getTranslated(context, 'SHIPPING_PO_LBL')!, 'assets/images/shipping_policy.svg'),

        // _getDivider(),

        _getDrawerItem(getTranslated(context, 'RETURN_PO_LBL')!, 'assets/images/return_policy.svg'),

        // _getDivider(),

        _getDrawerItem(getTranslated(context, 'RATE_US')!, 'assets/images/pro_rateus.svg'),

        // _getDivider(),

        _getDrawerItem(getTranslated(context, 'SHARE_APP')!, 'assets/images/pro_share.svg'),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null ? Container() : _getDrawerItem(getTranslated(context, 'DEL_ACC_LBL')!, ''),

        // CUR_MERCHANTID == "" || CUR_MERCHANTID == null ? Container() : _getDivider(),

        CUR_MERCHANTID == "" || CUR_MERCHANTID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'LOGOUT')!, 'assets/images/pro_logout.svg'),
      ],
    );
  }
  ...
  _getDrawerItem(String title, String img) {
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(
          title,
          style: TextStyle(color: Theme.of(context).colorScheme.lightBlack, fontSize: 15, fontWeight: FontWeight.normal),
        ),
        onTap: () {
  ...
  deleteConfirmDailog() {
    ...
    return AlertDialog(
      ...
      title: Text(getTranslated(context, 'DEL_YR_ACC_LBL')!, textAlign: TextAlign.center),
      content: StatefulBuilder(builder: (context, StateSetter setStater) {
        ...
        return Form(
          ...
          child: Column(
            ...
            children: [
              Text(
                from == 0 ? getTranslated(context, 'DEL_WHOLE_TXT_LBL')! : getTranslated(context, 'ADD_PASS_DEL_LBL')!,
                textAlign: TextAlign.center,
                style: Theme.of(this.context).textTheme.subtitle2!.copyWith(color: Theme.of(context).colorScheme.fontColor.withOpacity(0.8)),
              ),
              if (from == 1)
                Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        autofocus: false,
                        style: Theme.of(context).textTheme.bodyText1!.copyWith(color: Theme.of(context).colorScheme.fontColor),
                        onSaved: (val) {
                          setStater(() {
                            pass = val;
                          });
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: const EdgeInsets.fromLTRB(15.0, 10.0, 10, 10.0),
              ...
              Padding(
                ...
                child: from == 0
                    ? Row(
                        ...
                        children: [
                          CupertinoButton(
                              ...
                              child: Container(
                                  padding: EdgeInsetsDirectional.only(top: 10, bottom: 10, start: 20, end: 20),
                          ...
                          CupertinoButton(
                              ...
                              child: Container(
                                  ...
                                  alignment: FractionalOffset.center,
                                  decoration: BoxDecoration(
                                    color: countDownComplete ? colors.primary : Theme.of(context).colorScheme.lightWhite,
                                    borderRadius: BorderRadius.all(Radius.circular(5.0)),
                                  ),
                                  child: Text(getTranslated(context, 'CONFIRM')!,
                                      textAlign: TextAlign.center,
                                      style: Theme.of(context).textTheme.subtitle2!.copyWith(
                                            color: countDownComplete ? Theme.of(context).colorScheme.white : Theme.of(context).colorScheme.lightBlack,
                                            fontWeight: FontWeight.bold,
                                          )))),
                        ],
                      )
                    : InkWell(
                        ...
                        child: Container(
                            margin: EdgeInsetsDirectional.only(top: 10, bottom: 10, start: deviceWidth! / 5.3, end: deviceWidth! / 5.3),
                            height: 40,
                            alignment: FractionalOffset.center,
                            decoration: BoxDecoration(
                              color: colors.primary,
  ...
  Future<void> setDeleteAcc() async {
    ...
    if (_isNetworkAvail) {
      try {
        var parameter = {USER_ID: CUR_MERCHANTID, PASSWORD: passController.text.trim(), MOBILE: mob};
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                color: curTheme == index ? colors.primary : Theme.of(context).colorScheme.white,
                                border: Border.all(color: colors.primary)),
                            child: Padding(
                                padding: const EdgeInsets.all(2.0),
                          ...
                          Padding(
                              ...
                              child: Text(
                                themeList[index]!,
                                style: Theme.of(ctx).textTheme.subtitle1!.copyWith(color: Theme.of(context).colorScheme.lightBlack),
                              ))
                        ],
                      ),
    ...
    await dialogAnimate(
        ...
        AlertDialog(
          ...
          content: Text(
            ...
            style: Theme.of(this.context).textTheme.subtitle1!.copyWith(color: Theme.of(this.context).colorScheme.fontColor),
          ),
          actions: <Widget>[
            TextButton(
                child: Text(
                  ...
                  style: Theme.of(this.context)
                      .textTheme
                      .subtitle2!
                      .copyWith(color: Theme.of(this.context).colorScheme.lightBlack, fontWeight: FontWeight.bold),
                ),
                onPressed: () {
            ...
            TextButton(
                child: Text(
                  ...
                  style: Theme.of(this.context)
                      .textTheme
                      .subtitle2!
                      .copyWith(color: Theme.of(this.context).colorScheme.fontColor, fontWeight: FontWeight.bold),
                ),
                onPressed: () async {
                  SettingProvider settingProvider = Provider.of<SettingProvider>(context, listen: false);
        ...
        child: Stack(
          children: <Widget>[
            Container(
              ...
              height: 80,
              width: 80,
              decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(width: 1.0, color: Theme.of(context).colorScheme.white)),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(100.0),
                child: Consumer<UserProvider>(builder: (context, userProvider, _) {
                  return userProvider.curMerchantUserImage != ''
                      ? FadeInImage(
                          fadeInDuration: const Duration(milliseconds: 150),
                          image: NetworkImage(userProvider.curMerchantUserImage),
                          height: 64.0,
                          width: 64.0,
                          fit: BoxFit.cover,
                          imageErrorBuilder: (context, error, stackTrace) => erroWidget(64),
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Selector<UserProvider, String>(
                      //     selector: (_, provider) => provider.curMerchantEmail,
                      //     builder: (context, userEmail, child) {
                      //       return setComNameField(userEmail);
                      //     }),
    ...
    if (_isNetworkAvail) {
      try {
        ...
        if (!error) {
          ...
          var userProvider = Provider.of<UserProvider>(context, listen: false);
          userProvider.setMerchantUserImage(image!);
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  label: Text(getTranslated(context, "NAME_LBL")!), fillColor: Theme.of(context).colorScheme.white, border: InputBorder.none),
  ...
  Widget setComNameField(String comName) => Padding(
        padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 15.0),
        child: Container(
          padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom),
          decoration: BoxDecoration(
          ...
          child: Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  label: Text(getTranslated(context, "EMAILHINT_LBL")!), fillColor: Theme.of(context).colorScheme.white, border: InputBorder.none),
  ...
  Widget saveButton(String title, VoidCallback? onBtnSelected) {
    return Padding(
        padding: const EdgeInsetsDirectional.only(start: 8.0, end: 8.0, top: 15.0),
        child: SimBtn(
  ...
  Future<bool> validateAndSave(GlobalKey<FormState> key) async {
    ...
    if (form.validate()) {
      if (key == _changePwdKey) {
        await setUpdateUser(CUR_MERCHANTID!, passwordController.text, newpassController.text, "", "");
        passwordController.clear();
        newpassController.clear();
        passwordController.clear();
        confirmpassController.clear();
      } else if (key == _changeUserDetailsKey) {
        setUpdateUser(CUR_MERCHANTID!, "", "", nameController.text, comNameController.text);
      }
      return true;
    }
    return false;
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            obscuringCharacter: "*",
            decoration: InputDecoration(
                label: Text(getTranslated(context, "CUR_PASS_LBL")!), fillColor: Theme.of(context).colorScheme.white, border: InputBorder.none),
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            obscuringCharacter: "*",
            decoration: InputDecoration(
                label: Text(getTranslated(context, "NEW_PASS_LBL")!), fillColor: Theme.of(context).colorScheme.white, border: InputBorder.none),
            onSaved: (String? value) {
              newPwd = value;
            },
            validator: (val) => validatePass(val!, getTranslated(context, 'PWD_REQUIRED'), getTranslated(context, 'PWD_LENGTH')),
