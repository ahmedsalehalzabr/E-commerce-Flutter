    ...
    return InkWell(
      child: Column(
        children: <Widget>[
          Expanded(
            child: Padding(
              ...
              child: ClipRRect(
                  ...
                  child: FadeInImage(
                    image: NetworkImage(subList![index].category_image!),
          ...
          Text(
            "${subList![index].category_name!.toLowerCase().capitalize()}\n",
          ...
          Navigator.push(
              ...
              CupertinoPageRoute(
                builder: (context) => ProductList(
                  category_name: subList![index].category_name,
                  category_id: subList![index].category_id,
                  tag: false,
                  fromSeller: false,
                ),
              ));
          ...
          Navigator.push(
              ...
              CupertinoPageRoute(
                builder: (context) => SubCategory(
                  ...
                  title: subList![index].category_name!.toUpperCase(),
                ),
              ));
        }
      },
