...
class Write_Review extends StatefulWidget {
  ...
  Write_Review(this.screenContext, this.productId, this.userReview, this.userStarRating, {Key? key}) : super(key: key);
            ...
            child: MaterialButton(
              ...
              onPressed: () {
                if (curRating != 0 || commentTextController.text != '' || (reviewPhotos.isNotEmpty)) {
                  setRating(curRating, commentTextController.text, reviewPhotos, productID);
                } else {
