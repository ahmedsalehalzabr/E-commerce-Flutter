  ...
  Future<void> validatePromo(String promo) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        setState(() {});
        var parameter = {USER_ID: CUR_MERCHANTID, PROMOCODE: promo, FINAL_TOTAL: oriPrice.toString()};
                                                        ...
                                                        children: [
                                                          ...
                                                          Row(
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                child: promoList[index].repeatUsage == "Allowed"
                                                                    ? Text(
                                                                        "${getTranslated(context, "MAX_APPLICABLE")!}  ${promoList[index].noOfRepeatUsage} times",
                                                                        style: const TextStyle(fontSize: 12))
                                                                    : Text(getTranslated(context, "OFFER_VALID_ONCE")!,
                                                                        style: const TextStyle(fontSize: 12)),
                                                              ),
                                                            ],
                                                          ),
                                                      ...
                                                      : Row(
                                                          children: [
                                                            ...
                                                            SimBtn(
                                                              ...
                                                              width: 0.2,
                                                              onBtnSelected: () {
                                                                validatePromo(promoList[index].promoCode!);
                                                              },
                                                            ),
                                                          ],
                                                        )),
